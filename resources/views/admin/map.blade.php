...
<div class="animate-fade-in">
    <div style="display: flex; justify-content: space-between; align-items: flex-end; margin-bottom: 1rem;">
        ...
        <div style="display: flex; gap: 0.5rem; align-items: center;">
            <button onclick="refreshHazards(true)" class="btn btn-ghost" style="font-size: 0.8rem; padding: 0.4rem 0.8rem; display: inline-flex; align-items: center; gap: 0.35rem;">
...
<script>
    ...
    function initMap() {
        ...
        window._mapBaseTiles = { dark: darkTile, light: lightTile };
        ...
        window.addEventListener('pscp-theme-changed', function(e) {
            ...
            const tiles = window._mapBaseTiles;
            if (newTheme === 'light') {
    ...
    function applyEmployeeFilters() { 
        employeeMarkers.forEach(m => { 
            ...
            matchesFilter ? map.addLayer(m.marker) : map.removeLayer(m.marker); 
        }); 
        updateHeaderCount();
    }
